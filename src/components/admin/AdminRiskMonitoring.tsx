...
const AdminRiskMonitoring = () => {
  ...
  const statCards = [
    ...
    { label: "Defaulted Contracts", value: defaultedContracts.length, icon: TrendingDown, color: "text-gold/100", bg: "bg-gold/100/10" },
    { label: "Overdue Amount", value: `R${overdueAmount.toLocaleString()}`, icon: Shield, color: "text-amber-600", bg: "bg-gold/100/10" },
